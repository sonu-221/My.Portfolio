import { ArrowRight, Download, Mail, Linkedin, Sparkles } from 'lucide-react';
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12 lg:px-20 grid lg:grid-cols-12 gap-12 items-center w-full">
        ...
        <div className="lg:col-span-7">
          ...
          <div className="mt-8 flex items-center gap-4 animate-fade-up [animation-delay:480ms] opacity-0">
            <a
